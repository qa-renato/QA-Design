...
export function MidCTA() {
  ...
  return (
    <section
      ...
      style={{ background: 'linear-gradient(135deg, #023c8f 0%, #0065fe 50%, #0c0a3b 100%)' }}
    >
      <div
        className="absolute inset-0 pointer-events-none"
        aria-hidden="true"
        style={{ background: 'radial-gradient(ellipse at 20% 50%, rgba(21,183,254,0.15) 0%, transparent 60%), radial-gradient(ellipse at 80% 50%, rgba(2,60,143,0.4) 0%, transparent 60%)' }}
      />
      <Reveal className="relative max-w-[1200px] mx-auto px-6 lg:px-8">
