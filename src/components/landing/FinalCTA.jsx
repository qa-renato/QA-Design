  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[500px] rounded-full bg-[radial-gradient(ellipse,rgba(0,101,254,0.18)_0%,transparent_65%)]" />
        <div className="absolute top-0 right-0 w-[300px] h-[300px] rounded-full bg-[radial-gradient(ellipse,rgba(21,183,254,0.10)_0%,transparent_65%)]" />
        <div className="absolute bottom-0 left-0 w-[350px] h-[350px] rounded-full bg-[radial-gradient(ellipse,rgba(21,183,254,0.07)_0%,transparent_65%)]" />
      </div>
      ...
      <div className="relative max-w-[1200px] mx-auto px-6 lg:px-8 text-center">
        ...
        <div className="flex justify-center mb-6">
          <Badge variant="accent">Fale com a InBot</Badge>
        </div>
        ...
        {/* CTA duplo — primário pill + secundário outline */}
