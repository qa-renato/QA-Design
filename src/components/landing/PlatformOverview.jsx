...
import { platform } from '../../data/landingContent'

function PillarCard({ icon, title, description }) {
  return (
    <div className="group flex flex-col gap-3 p-6 rounded-2xl bg-[#12103d] border border-[rgba(21,183,254,0.1)] transition-all duration-300 hover:border-[rgba(21,183,254,0.3)] hover:bg-[#14123f]">
      <span
